...
do_install() {
    ...
    install -d ${D}/opt/2gig/sounds/wav
    install -d ${D}/opt/2gig/sounds/wav/clicks
    cp -dR ${S}/wav/* ${D}/opt/2gig/sounds/wav
    cp -dR ${S}/content/sounds/* ${D}/opt/2gig/sounds/wav/clicks
...
FILES_${PN} += "${datadir} /opt/2gig/sounds/*"
