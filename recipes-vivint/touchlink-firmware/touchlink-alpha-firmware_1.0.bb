...
FIRMWARE_CS6022_OV4689 = "update_CS-6022_1.1.2_468.bin"
FIRMWARE_DIR = "/var/lib/firmware/AlphaNetwork"

SRC_URI = "http://${UPDATESENG}/camera_firmwares/Alpha/${FIRMWARE_CS6022_OV4689}"

SRC_URI[md5sum] = "94d09aa0a4ea26b427d4aefd73d56f39"
SRC_URI[sha256sum] = "01f2c955844ed8d868d5c965dbb0a79d2dfcf47efcf84dfe80269cc6233042d5"

PV_prepend = "1"
PKGR_${PN}-cs6022-ov4689 = "${PR}.64"
