...
do_install() {
	...
	install -m 0644 Makefile.sysroot ${D}${libdir}/python${PYTHON_MAJMIN}/config-${PYTHON_MAJMIN}${PYTHON_ABI}m/Makefile
...
py_package_preprocess () {
	...
	install -m 0644 ${B}/Makefile.orig ${PKGD}${libdir}/python${PYTHON_MAJMIN}/config-${PYTHON_MAJMIN}${PYTHON_ABI}m/Makefile
	# Remove references to buildmachine paths in target Makefile and _sysconfigdata
	sed -i -e 's:--sysroot=${STAGING_DIR_TARGET}::g' -e s:'--with-libtool-sysroot=${STAGING_DIR_TARGET}'::g \
		${PKGD}${libdir}/python${PYTHON_MAJMIN}/config/Makefile \
		${PKGD}${libdir}/python${PYTHON_MAJMIN}/config-${PYTHON_MAJMIN}${PYTHON_ABI}m/Makefile \
...
FILES_${PN}-misc-dbg = "${STAGING_LIBDIR_NATIVE}/python${PYTHON_MAJMIN}/lib-dynload/.debug"
